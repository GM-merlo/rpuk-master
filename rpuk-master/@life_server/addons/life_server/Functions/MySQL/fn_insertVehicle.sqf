...
if(_uid == "" OR _side == "" OR _type == "" OR _className == "" OR _color == -1 OR _plate == -1) exitWith {hint "ERROR";};
[format["insertVehicle:%1:%2:%3:%4:%5:%6",_side,_className,_type,_uid,_color,_plate],1] call DB_fnc_preparedCall;