...
_dataArr = _control lbData _selection;
_dataArr = call compile _dataArr;
_data = _dataArr select 0;
_customUniform = _dataArr select 1;
...
if(_customUniform != -1 && life_clothing_filter == 0) then {
	player setVariable["customUniform",[_data, _customUniform], true];
} else {
...
//NDJ 03May14 - if cop, retexture me (updated for medics 21Jul14
