...
_money = _display displayCtrl 2701;
_units = _display displayCtrl 2703;

lbClear _units;
_text ctrlSetStructuredText parseText format["<img size='1.7' image='icons\bank.paa'/> £%1<br/><img size='1.6' image='icons\money.paa'/> £%2",[RPUK_doshinbank] call life_fnc_numberText,[RPUK_dosh] call life_fnc_numberText];
...
lbSort _units; //NDJ 16May14 Sort the list alphabetically
