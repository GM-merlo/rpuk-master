/*
	...
	BLAH
*/
private["_allowedItems","_loadout","_primary","_launcher","_handgun","_magazines","_uniform","_vest","_backpack","_items","_primitems","_secitems","_handgunitems","_uitems","_vitems","_bitems","_headgear","_goggles","_handle"];
...
if(_headgear != "") then {player addHeadgear _headgear} else {removeHeadgear player};
if(_goggles != "") then {player addGoggles _goggles} else {removeGoggles player};
waitUntil {uniform player == _uniform};
