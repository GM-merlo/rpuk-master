...
if({side _x == west} count playableUnits < 10) exitWith {hint localize "STR_Civ_NotEnoughCops"}; //Not enough cops online!

if(!([false,"blastingcharge",1] call life_fnc_handleInv)) exitWith {}; //Error?

_vault setVariable["chargeplaced",true,true];
[1,localize "STR_ISTR_Blast_Placed"] remoteExecCall ["life_fnc_broadcast",west];
