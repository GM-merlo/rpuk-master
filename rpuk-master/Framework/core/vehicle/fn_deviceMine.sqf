...
_resourceZones = [
	"frog_1","apple_1","apple_2","apple_3","apple_4",
	"potato_1","potato_2",
...
_item = switch(true) do {
	...
	case (_zone in ["potato_1","potato_2"]): {"potato"};
	...
	case (_zone in ["frog_1","frog_2"]): {"frogleg";};

	case (_zone in ["cocoa_1","cocoa_2","cocoa_3","cocoa_4"]): {"cocoa";};
	case (_zone in ["tree_1","tree_2","tree_3","tree_4"]): {"log";};
	case (_zone in ["banana_1","banana_2","banana_3","banana_4"]): {"sbanana";};
	case (_zone in ["sugar_1","sugar_2","sugar_3","sugar_4"]): {"sugarcane";};
	case (_zone in ["tobacco_1","tobacco_2","tobacco_3","tobacco_4"]): {"tobaccoleaves";};
	case (_zone in ["mango_1","mango_2","mango_3","mango_4"]): {"mango";};
	case (_zone in ["orange_1","orange_2","orange_3","orange_4"]): {"orange";};
	case (_zone in ["kiwi_1","kiwi_2","kiwi_3","kiwi_4"]): {"kiwi";};
	case (_zone in ["coconut_1","coconut_2","coconut_3","coconut_4"]): {"coconut";};
