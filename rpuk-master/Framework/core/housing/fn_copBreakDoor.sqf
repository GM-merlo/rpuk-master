...
[[_house, "shopalarm",40],"life_fnc_playSound",true,false] spawn life_fnc_MP; //Lets send out a little sound to alert near by people.

private _housegridpos = [_house] call life_fnc_toGridRef; 

[0,format[localize "STR_ISTR_Bolt_AlertHouse",_housegridpos]] remoteExecCall ["life_fnc_broadcast", _uid call BIS_fnc_getUnitByUid];
