...
if(RPUK_doshinbank < (__GETC__(life_gangPrice))) exitWith {hint format[localize "STR_GNOTF_NotEnoughMoney",[((__GETC__(life_gangPrice))-RPUK_doshinbank)] call life_fnc_numberText];};
