/*
	...
	Description:
	Catches a fish that is near by. (Or a Rabbit! NDJ)
*/
private["_fish","_type"];
_fish = [_this,0,ObjNull,[ObjNull]] call BIS_fnc_param;
if((!(_fish isKindOf "Fish_Base_F")) && (!(typeOf _fish == "Rabbit_F"))) exitWith {}; //Not a fishy!  //NDJ 11May14 - and not a rabbit either!
...
switch(true) do
{
	...
	case ((typeOf _fish) == "Rabbit_F") : {_type = "rabbit"};
	default {_type = ""};
};
