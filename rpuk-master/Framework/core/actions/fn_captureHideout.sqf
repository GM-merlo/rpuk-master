...
for "_i" from 0 to 1 step 0 do
{
	...
	if(life_istazed || life_isknockedout) exitWith {_flag setVariable["inCapture",false,true];}; //Tazed or knocked out
...
if(!alive player OR life_istazed OR life_isknockedout) exitWith {life_action_inUse = false;_flag setVariable["inCapture",false,true];};
...
[[0,1],format[localize "STR_GNOTF_CaptureSuccess",name player,(group player) getVariable "gang_name" ]] remoteExec ["life_fnc_broadcast",-2];
