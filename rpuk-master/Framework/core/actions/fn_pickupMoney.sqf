...
//--- Fixed Pickup Bug - Ciaran - 14/10/2015 18:02
if({!(_x getVariable ['bankItem', false])} count allMissionObjects "Land_Money_F" > 25) exitWith {
	_obj setVariable["inUse",false,true];
};
if((_obj getVariable["scenery",false])) exitWith {}; //Scenery!
