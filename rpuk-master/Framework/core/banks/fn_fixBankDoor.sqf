/*
	File: fn_fixBankDoor.sqf

	Author: Ciaran Langton
	Date: 2015-05-31 20:53:48
	Last Modified by: Ciaran Langton
	Last Modified time: 2015-05-31 22:41:44
*/
private["_building","_doors","_door","_cP","_cpRate","_ui","_title","_titleText"];
_building = [_this,0,ObjNull,[ObjNull]] call BIS_fnc_param;
if(isNull _building) exitWith {};
if(!(_building isKindOf "House_F")) exitWith {hint "You are not looking at a bank."};
if(!(_building getVariable ["isBank", false])) exitWith {hint "You are not looking at a bank."};
_doors = 1;
...
if(_door in (_building getVariable["bankBlocked",[]])) exitWith {hint "This door appears to be sealed off.";};
if((_building getVariable[format["bis_disabled_Door_%1",_door],0]) == 1) exitWith {hint "This door is already closed."};
