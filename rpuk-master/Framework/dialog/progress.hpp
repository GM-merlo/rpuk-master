...
class ALUK_codebreaker
{
	name = "ALUK_codebreaker";
	idd = 345345;
	fadeIn = 0;
	duration = 999999999999;
	fadeout = 0;
	movingEnable = 0;
	onLoad = "uiNamespace setVariable['ALUK_codebreaker', _this select 0]";
	objects[] = {};

	class controlsBackground
	{
		class CodeLockImg: Life_RscPicture
		{
			idc = 1200;
			text = "icons\codebreaker.paa";
			x = -0.00782237 * safezoneW + safezoneX;
			y = 0.485996 * safezoneH + safezoneY;
			w = 0.163701 * safezoneW;
			h = 0.52377 * safezoneH;
		};
	};
	...
	class controls
	{
		class CodeLockText: Life_RscStructuredText
		{
			idc = 65656;
			text = "<t size='2.3'></t>";
			x = 0.0399727 * safezoneW + safezoneX;
			y = 0.570022 * safezoneH + safezoneY;
			w = 0.0657182 * safezoneW;
			h = 0.0840263 * safezoneH;
		};
	};
};
