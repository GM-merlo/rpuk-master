class SettingsMenu
{
	...
	class controlsBackground
	{
		...
		{
			idc = -1;
			text = "Enable Roleplay UK HUD";
			
			y = 0.53;
		};

		class KavalaModeEnable : PlayerTagsHeader
		{
			idc = -1;
		...
		class EnvironmentModeEnable : PlayerTagsHeader
		{
			idc = -1;
	...
	class controls
	{
		...
		{
			tooltip = "$STR_GUI_LowDetail";
			idc = 2973;
			y = 0.58;
		};
		
		class EnvironmentONOFF : PlayerTagsONOFF
		{
			tooltip = "$STR_GUI_AmbEnvironment";
			idc = 2974;
			y = 0.63;
		};
