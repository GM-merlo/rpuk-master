class Life_my_smartphone {
	...
	onUnload = "life_smartphoneID = -1; life_smartphoneTarget = objNull;";
...
class Life_smartphone_notruf {
	...
	class controls {
		...
		class RepairManRequest : life_RscButtonMenu
		{
			idc = 888899;
			text = "$STR_CELL_RepairRequest";
			colorBackground[] = {0.584, 0.086, 0.086,1.0};
