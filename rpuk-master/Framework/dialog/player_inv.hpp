...
class playerSettings {
	...
	class controls {
		...
		class ButtonWantedList : Life_RscButtonMenu {
			...
			onButtonClick = "[false] call life_fnc_wantedMenu";
			x = 0.1 + (6.25 / 19.8) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.8 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
		...
		class ButtonCell : Life_RscButtonMenu {
			...
			onButtonClick = "[] spawn life_fnc_mobileOpen;";
		...
		class ButtonMarket : Life_RscButtonMenu {
			idc = 2020;
			text = "Market";
			onButtonClick = "[] spawn life_fnc_marketPricesOpen;";
			x = 0.1 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.805;
			w = (6.25 / 40);
			h = (1 / 25);
		...
		/*class ButtonProfessions : Life_RscButtonMenu {
			idc = 2019;
			text = "$STR_PM_Professions";
			onButtonClick = "[] call life_fnc_professionMenu;";
			x = 0.26 + (6.25 / 19.8) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.805;
			w = (6.25 / 40);
			h = (1 / 25);
